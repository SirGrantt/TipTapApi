...
namespace TipTapApi.Migrations
{
    ...
    [Migration("20180726230845_AddedBarbackTipoutsToTipoutClass")]
    partial class AddedBarbackTipoutsToTipoutClass
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Entities.CheckoutEntity", b =>
                {
                    ...
                    b.Property<decimal>("BarSpecialLine");
                    ...
                    b.Property<decimal>("SaSpecialLine");
            ...
            modelBuilder.Entity("Common.Entities.SupportHoursEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Common.Entities.TeamCheckoutEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TeamCheckouts");
                });

            modelBuilder.Entity("Common.Entities.TeamEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Common.Entities.TeamCheckoutEntity", b =>
                {
                    ...
                    b.HasOne("Common.Entities.TeamEntity", "Team")
                        .WithMany()
            ...
            modelBuilder.Entity("Common.Entities.TipOutEntity", b =>
                {
                    b.HasOne("Common.Entities.TeamEntity", "ServerTeam")
                        .WithMany()
